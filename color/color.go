...
import (
	_da "fmt"
	_dc "github.com/sanhuanshisanshao/unioffice"
)
...
func FromHex(s string) Color {
	...
	var _ecc, _bd, _ac uint8
	_c, _ := _da.Sscanf(s, "\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", &_ecc, &_bd, &_ac)
	if _c == 3 {
		return RGB(_ecc, _bd, _ac)
	}
	return Auto
}
...
func (_a Color) IsAuto() bool { return _a._f }
...
func (_dg Color) AsRGBString() *string {
	return _dc.Stringf("\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _dg._e, _dg._b, _dg._ec)
}
...
// to a string containing a six digit hex RGB value.
func (_ef Color) AsRGBAString() *string {
	return _dc.Stringf("\u0025\u00302\u0078\u0025\u00302\u0078\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _ef._bg, _ef._e, _ef._b, _ef._ec)
}
