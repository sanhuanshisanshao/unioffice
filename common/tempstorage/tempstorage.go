...
func SetAsStorage(newStorage storage) { _ee = newStorage }

type storage interface {
	Open(_e string) (File, error)
	TempFile(_ga, _b string) (File, error)
	TempDir(_ea string) (string, error)
	RemoveAll(_c string) error
	Add(_d string) error
}
