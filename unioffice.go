...
The packages of interest are github.com/sanhuanshisanshao/unioffice/document,
unidoc/unioffice/spreadsheet and github.com/sanhuanshisanshao/unioffice/presentation.
...
import (
	...
	_ad "errors"
	_b "fmt"
	_fc "github.com/sanhuanshisanshao/unioffice/algo"
...
func AbsoluteFilename(dt DocType, typ string, index int) string {
	...
	case CustomXMLType:
		return _b.Sprintf("c\u0075s\u0074\u006f\u006d\u0058\u006d\u006c\u002f\u0069t\u0065\u006d\u0025\u0064.x\u006d\u006c", index)
	...
	case OfficeDocumentType, OfficeDocumentTypeStrict:
		...
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case ThemeType, ThemeTypeStrict, ThemeContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("x\u006c/\u0074\u0068\u0065\u006d\u0065\u002f\u0074\u0068e\u006d\u0065\u0025\u0064.x\u006d\u006c", index)
		case DocTypeDocument:
			return _b.Sprintf("\u0077\u006f\u0072\u0064/t\u0068\u0065\u006d\u0065\u002f\u0074\u0068\u0065\u006d\u0065\u0025\u0064\u002e\u0078m\u006c", index)
		case DocTypePresentation:
			return _b.Sprintf("p\u0070\u0074\u002f\u0074he\u006de\u002f\u0074\u0068\u0065\u006de\u0025\u0064\u002e\u0078\u006d\u006c", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	...
	case ChartType, ChartTypeStrict, ChartContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("x\u006c\u002f\u0063\u0068ar\u0074s\u002f\u0063\u0068\u0061\u0072t\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
			return _b.Sprintf("\u0077\u006f\u0072d/\u0063\u0068\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypePresentation:
			return _b.Sprintf("\u0070\u0070\u0074\u002fch\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078m\u006c", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case TableType, TableTypeStrict, TableContentType:
		return _b.Sprintf("x\u006c\u002f\u0074\u0061bl\u0065s\u002f\u0074\u0061\u0062\u006ce\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case DrawingType, DrawingTypeStrict, DrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("\u0078l\u002f\u0064\u0072\u0061w\u0069\u006e\u0067\u0073\u002fd\u0072a\u0077i\u006e\u0067\u0025\u0064\u002e\u0078\u006dl", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case CommentsType, CommentsTypeStrict, CommentsContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("\u0078\u006c\u002f\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073\u0025d\u002e\u0078\u006d\u006c", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case VMLDrawingType, VMLDrawingTypeStrict, VMLDrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("\u0078\u006c\u002f\u0064r\u0061\u0077\u0069\u006e\u0067\u0073\u002f\u0076\u006d\u006cD\u0072a\u0077\u0069\u006e\u0067\u0025\u0064\u002ev\u006d\u006c", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case ImageType, ImageTypeStrict:
		switch dt {
		case DocTypeDocument:
			return _b.Sprintf("\u0077\u006f\u0072\u0064/m\u0065\u0064\u0069\u0061\u002f\u0069\u006d\u0061\u0067\u0065\u0025\u0064\u002e\u0070n\u0067", index)
		case DocTypeSpreadsheet:
			return _b.Sprintf("x\u006c/\u006d\u0065\u0064\u0069\u0061\u002f\u0069\u006da\u0067\u0065\u0025\u0064.p\u006e\u0067", index)
		case DocTypePresentation:
			return _b.Sprintf("p\u0070\u0074\u002f\u006ded\u0069a\u002f\u0069\u006d\u0061\u0067e\u0025\u0064\u002e\u0070\u006e\u0067", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case WorksheetType, WorksheetTypeStrict, WorksheetContentType:
		return _b.Sprintf("\u0078l\u002f\u0077\u006f\u0072k\u0073\u0068\u0065\u0065\u0074s\u002fs\u0068e\u0065\u0074\u0025\u0064\u002e\u0078\u006dl", index)
	...
	case HeaderType, HeaderTypeStrict:
		return _b.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0068\u0065\u0061\u0064\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case FooterType, FooterTypeStrict:
		return _b.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0066\u006f\u006f\u0074\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case ControlType, ControlTypeStrict:
		switch dt {
		case DocTypeSpreadsheet:
			return _b.Sprintf("\u0078l\u002f\u0061\u0063\u0074\u0069\u0076\u0065\u0058\u002f\u0061\u0063t\u0069\u0076\u0065\u0058\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
			return _b.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0061\u0063\u0074\u0069\u0076\u0065X\u002f\u0061\u0063\u0074\u0069\u0076\u0065\u0058\u0025\u0064.\u0078\u006d\u006c", index)
		case DocTypePresentation:
			return _b.Sprintf("\u0070p\u0074\u002f\u0061\u0063t\u0069\u0076\u0065\u0058\u002fa\u0063t\u0069v\u0065\u0058\u0025\u0064\u002e\u0078\u006dl", index)
		default:
			_ff.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case SlideType, SlideTypeStrict:
		return _b.Sprintf("\u0070\u0070\u0074\u002fsl\u0069\u0064\u0065\u0073\u002f\u0073\u006c\u0069\u0064\u0065\u0025\u0064\u002e\u0078m\u006c", index)
	case SlideLayoutType:
		return _b.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004c\u0061\u0079\u006f\u0075t\u0073/\u0073l\u0069d\u0065\u004c\u0061\u0079\u006f\u0075\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case SlideMasterType:
		return _b.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004d\u0061\u0073\u0074\u0065r\u0073/\u0073l\u0069d\u0065\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case HandoutMasterType:
		return _b.Sprintf("\u0070\u0070\u0074\u002f\u0068\u0061\u006e\u0064\u006f\u0075\u0074\u004d\u0061\u0073\u0074\u0065\u0072\u0073\u002f\u0068\u0061\u006e\u0064\u006fu\u0074\u004d\u0061\u0073\u0074e\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case NotesMasterType:
		return _b.Sprintf("\u0070\u0070\u0074/n\u006f\u0074\u0065\u0073\u004d\u0061\u0073\u0074\u0065r\u0073/\u006eo\u0074e\u0073\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	default:
		_ff.Log.Debug("\u0075\u006e\u0073\u0075pp\u006f\u0072\u0074\u0065\u0064\u0020\u0074\u0079\u0070\u0065\u0020\u0025\u0073", typ)
	}
	return ""
}
...
type any struct {
	XMLName _d.Name
	Attrs   []_d.Attr `xml:",any,attr"`
	Nodes   []*any    `xml:",any"`
	Data    []byte    `xml:",chardata"`
}

var _bac = map[string]bool{"\u0077\u0031\u0030": true, "\u0077\u0031\u0034": true, "\u0077\u0070\u0031\u0034": true, "\u0077\u0031\u0035": true, "\u0078\u0031\u0035a\u0063": true, "\u0077\u0031\u0036s\u0065": true, "\u0077\u0031\u0036\u0063\u0069\u0064": true, "\u0077\u0031\u0036": true, "\u0077\u0031\u0036\u0063\u0065\u0078": true}

// Bool returns a copy of v as a pointer.
func Bool(v bool) *bool { _dab := v; return &_dab }
func (_gae *nsSet) getPrefix(_be string) string {
	if _efa, _ecc := _ea[_be]; _ecc {
		if _, _dgba := _gae._gc[_efa]; !_dgba {
			_gae._gc[_efa] = _be
			_gae._fa[_be] = _efa
			_gae._fgd = append(_gae._fgd, _efa)
		}
		return _efa
	}
	_be = _eg.TrimFunc(_be, func(_bf rune) bool { return !_a.IsLetter(_bf) })
	if _df, _aae := _gae._fa[_be]; _aae {
		return _df
	}
	_ae := _eg.Split(_be, "\u002f")
	_ae = _eg.Split(_ae[len(_ae)-1], "\u003a")
	_acg := _ae[len(_ae)-1]
	_cc := 0
	_gbbg := []byte{}
	for {
		if _cc < len(_acg) {
			_gbbg = append(_gbbg, _acg[_cc])
		} else {
			_gbbg = append(_gbbg, '_')
		}
		_cc++
		if _, _bfd := _gae._gc[string(_gbbg)]; !_bfd {
			_gae._gc[string(_gbbg)] = _be
			_gae._fa[_be] = string(_gbbg)
			_gae._fgd = append(_gae._fgd, string(_gbbg))
			return string(_gbbg)
		}
	}
}

const MinGoVersion = _gfg
...
func AbsoluteImageFilename(dt DocType, index int, fileExtension string) string {
	_ba := AbsoluteFilename(dt, ImageType, index)
	return _ba[0:len(_ba)-3] + fileExtension
}

var _eeb = map[string]interface{}{}

// UnmarshalXML implements the xml.Unmarshaler interface.
func (_eeg *XSDAny) UnmarshalXML(d *_d.Decoder, start _d.StartElement) error {
	_dad := any{}
	if _fd := d.DecodeElement(&_dad, &start); _fd != nil {
		return _fd
	}
	_aca(&_dad)
	_eeg.XMLName = _dad.XMLName
	_eeg.Attrs = _dad.Attrs
	_eeg.Data = _dad.Data
	_eeg.Nodes = _aff(_dad.Nodes)
	return nil
}

var _ea = func() map[string]string {
	_cd := map[string]string{}
	for _gd, _bcd := range _gbgb {
		_cd[_bcd] = _gd
	}
	return _cd
}()
...
func (_edbd *XSDAny) MarshalXML(e *_d.Encoder, start _d.StartElement) error {
	start.Name = _edbd.XMLName
	start.Attr = _edbd.Attrs
	_db := any{}
	_db.XMLName = _edbd.XMLName
	_db.Attrs = _edbd.Attrs
	_db.Data = _edbd.Data
	_db.Nodes = _ge(_edbd.Nodes)
	_dba := []string{}
	_dbc := false
	_adfb := nsSet{_fa: map[string]string{}, _gc: map[string]string{}}
	_edbd.collectNS(&_adfb)
	_adfb.applyToNode(&_db)
	for _, _gg := range _adfb._fgd {
		if _, _aee := _bac[_gg]; _aee {
			_dba = append(_dba, _gg)
		}
		_bab := _adfb._gc[_gg]
		_db.Attrs = append(_db.Attrs, _d.Attr{Name: _d.Name{Local: "\u0078\u006d\u006c\u006e\u0073\u003a" + _gg}, Value: _bab})
		if _gg == "\u006d\u0063" {
			_dbc = true
		}
	}
	for _, _cdd := range _db.Attrs {
		if _cdd.Name.Local == "\u006d\u0063\u003aI\u0067\u006e\u006f\u0072\u0061\u0062\u006c\u0065" {
			_dbc = false
			break
		}
	}
	if _dbc && len(_dba) > 0 {
		_db.Attrs = append(_db.Attrs, _d.Attr{Name: _d.Name{Local: "\u006d\u0063\u003aI\u0067\u006e\u006f\u0072\u0061\u0062\u006c\u0065"}, Value: _eg.Join(_dba, "\u0020")})
	}
	return e.Encode(&_db)
}
...
func RelativeImageFilename(dt DocType, relToTyp, typ string, index int, fileExtension string) string {
	_ec := RelativeFilename(dt, relToTyp, typ, index)
	return _ec[0:len(_ec)-3] + fileExtension
}
...
// resulting string.
func Stringf(f string, args ...interface{}) *string { _afa := _b.Sprintf(f, args...); return &_afa }

type nsSet struct {
	_fa  map[string]string
	_gc  map[string]string
	_fgd []string
}

func _aca(_gbb *any) {
	for _, _ege := range _gbb.Nodes {
		_aca(_ege)
	}
}
...
type Any interface {
	MarshalXML(_g *_d.Encoder, _bc _d.StartElement) error
	UnmarshalXML(_ag *_d.Decoder, _c _d.StartElement) error
}
...
func CreateElement(start _d.StartElement) (Any, error) {
	_ac, _dg := _eeb[start.Name.Space+"\u002f"+start.Name.Local]
	if !_dg {
		_dgg := &XSDAny{}
		return _dgg, nil
	}
	...
	_fcb := _aa.Call(nil)
	if len(_fcb) != 1 {
		return nil, _b.Errorf("\u0063\u006fn\u0073\u0074\u0072\u0075\u0063t\u006f\u0072\u0020\u0066\u0075n\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0072\u0065\u0074\u0075\u0072\u006e\u0020\u006f\u006e\u0065\u0020\u0076\u0061\u006c\u0075\u0065\u002c\u0020\u0067\u006f\u0074\u0020\u0025\u0064", len(_fcb))
	}
	_ega, _dg := _fcb[0].Interface().(Any)
	if !_dg {
		return nil, _ad.New("\u0063o\u006e\u0073t\u0072\u0075\u0063\u0074o\u0072\u0020\u0066u\u006e\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068ou\u006c\u0064\u0020r\u0065\u0074u\u0072\u006e\u0020\u0061\u006e\u0079 \u0027\u0041n\u0079\u0027")
	}
	return _ega, nil
}
...
func _ge(_def []*XSDAny) []*any {
	_gea := []*any{}
	for _, _gcf := range _def {
		_bcbc := &any{}
		_bcbc.XMLName = _gcf.XMLName
		_gfgb := []_d.Attr{}
		for _, _fag := range _gcf.Attrs {
			if _fag.Name.Local != "\u0078\u006d\u006cn\u0073" {
				_gfgb = append(_gfgb, _fag)
			}
		}
		_bcbc.Attrs = _gfgb
		_bcbc.Data = _gcf.Data
		_bcbc.Nodes = _ge(_gcf.Nodes)
		_gea = append(_gea, _bcbc)
	}
	return _gea
}
...
func RelativeFilename(dt DocType, relToTyp, typ string, index int) string {
	_adf := AbsoluteFilename(dt, typ, index)
	if relToTyp == "" {
		return _adf
	}
	_fg := AbsoluteFilename(dt, relToTyp, index)
	_da := _eg.Split(_fg, "\u002f")
	_ef := _eg.Split(_adf, "\u002f")
	_gb := 0
	for _agc := 0; _agc < len(_da); _agc++ {
		if _da[_agc] == _ef[_agc] {
			_gb++
		}
		if _agc+1 == len(_ef) {
			break
	...
	_gf := len(_da) - 1
	if _gf > 0 {
		return _fc.RepeatString("\u002e\u002e\u002f", _gf) + _eg.Join(_ef, "\u002f")
	}
	return _eg.Join(_ef, "\u002f")
}
...
func Int8(v int8) *int8 { _ffe := v; return &_ffe }
...
func _aff(_eac []*any) []*XSDAny {
	_dd := []*XSDAny{}
	for _, _ded := range _eac {
		_bg := &XSDAny{}
		_bg.XMLName = _ded.XMLName
		_bg.Attrs = _ded.Attrs
		_bg.Data = _ded.Data
		_bg.Nodes = _aff(_ded.Nodes)
		_dd = append(_dd, _bg)
	}
	return _dd
}
func (_bcb nsSet) applyToNode(_ffc *any) {
	if _ffc.XMLName.Space == "" {
		return
	}
	_fad := _bcb.getPrefix(_ffc.XMLName.Space)
	_ffc.XMLName.Space = ""
	_ffc.XMLName.Local = _fad + "\u003a" + _ffc.XMLName.Local
	_fe := _ffc.Attrs
	_ffc.Attrs = nil
	for _, _acc := range _fe {
		if _acc.Name.Space == "\u0078\u006d\u006cn\u0073" {
			continue
		}
		if _acc.Name.Space != "" {
			_fb := _bcb.getPrefix(_acc.Name.Space)
			_acc.Name.Space = ""
			_acc.Name.Local = _fb + "\u003a" + _acc.Name.Local
		}
		_ffc.Attrs = append(_ffc.Attrs, _acc)
	}
	for _, _fdg := range _ffc.Nodes {
		_bcb.applyToNode(_fdg)
	}
}
func (_fde *XSDAny) collectNS(_egg *nsSet) {
	if _fde.XMLName.Space != "" {
		_egg.getPrefix(_fde.XMLName.Space)
	}
	for _, _gaa := range _fde.Attrs {
		if _gaa.Name.Space != "" && _gaa.Name.Space != "\u0078\u006d\u006cn\u0073" {
			_egg.getPrefix(_gaa.Name.Space)
		}
	}
	for _, _dgc := range _fde.Nodes {
		_dgc.collectNS(_egg)
	}
}
